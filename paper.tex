...
\begin{figure}[ht]
	...
	\caption{Beispiel eines simplen MDP mit drei Zuständen $S_1, S_2, S_3$ und zwei Aktionen $a_0$ und $a_1$ dargestellt als Graph. Für jeden Zustand gibt es bei jeder Aktion eine ausgehende Kante mit der Wahrscheinlichkeit des Übergangs in den entsprechenden Zustand als Kantengewicht. Die gelben Pfeile symbolisieren die Belohnung bzw. die Kosten für bestimmte Übergänge. Im Allgemeinen müssen nicht notwendigerweise alle Aktionen von jedem Zustand aus wählbar sein. TODO Quelle: Wikipedia..?} %TODO Zu lang?
\end{figure}

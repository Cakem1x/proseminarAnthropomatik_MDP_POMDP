...
\end{equation}
klar werden. Ist unser Planungshorizont endlich, dann gibt es einen Zeitpunkt $n \in N$ nach dem Aktionen des Agenten nichts mehr etwas Wert ist. Demnach ist 
\begin{equation}
	\begin{split}
		V([ (s_0, a_0), (s_1, a_1), ..., (s_n, a_n)]) \\
